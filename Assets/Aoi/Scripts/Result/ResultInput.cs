...
public class ResultInput : MonoBehaviour
{
    ...
    private event Action<bool> m_onRTrigger;
    private event Action<bool> m_onLTrigger;
    ...
    public event Action<bool> OnRTrigger { add => m_onRTrigger += value;remove => m_onRTrigger -= value; }
    public event Action<bool> OnLTrigger { add => m_onLTrigger += value; remove => m_onLTrigger -= value; }
    ...
    private void Awake()
    {
        ...
        m_input.Normal.RTrigger.performed += OnSelectRTrigger;
        m_input.Normal.LTrigger.performed += OnSelectLTrigger;
    ...
    private void OnSelectRTrigger(InputAction.CallbackContext ctx) => m_onRTrigger?.Invoke(true);
    private void OnSelectLTrigger(InputAction.CallbackContext ctx) => m_onLTrigger?.Invoke(true);
